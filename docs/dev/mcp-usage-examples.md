...
```
1. list_validation_scenarios() → returns 159 scenarios (86 functional + 73 regression); each entry carries regression: true/false (regression entries also carry regression_issue: '#NNN')
