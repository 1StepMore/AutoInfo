...
> **This plan is superseded by `docs/archive/validation-suite/plan-v2/` (v2).**
>
> v2 covers 100% of AutoInfo's feature surface (98 questions, 15 parts) vs. v1's ~40% coverage.
> v1 is retained for reference only — do not use for new validation runs.
>
> See `docs/archive/validation-suite/plan-v2/README.md` for the current validation plan.
...
**Date:** 2026-07-20 (deprecated 2026-07-26)
