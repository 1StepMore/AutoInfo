...
**Validation**: `list_validation_scenarios` / `run_validation_scenario` — 162 scenarios
 (86 functional + 76 regression in `src/autoinfo/mcp/scenarios/regression/`); per-scenario timeout,
...
| Validation scenarios | **162 scenarios** (86 functional + 76 regression) |
| Demo domains | **21 demo domains** |
| LLM-required tools | **16 LLM-required tools** |
| Test suite | **~5538 tests** |
