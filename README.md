...
| Validation scenarios | ✅ 162 scenarios (86 functional + 76 regression in `src/autoinfo/mcp/scenarios/regression/`, `regression: true` key, recursive-glob auto-load) |
...
3. **Validate** — `list_validation_scenarios()` (162 scenarios: 86 functional + 76 regression) → `run_validation_scenario(scenario="system-health")`
