...
**Validation**: `list_validation_scenarios` / `run_validation_scenario` — 166 scenarios
 (86 functional + 80 regression in `src/autoinfo/mcp/scenarios/regression/`); per-scenario timeout,
