...
| End-user lifecycle / billing | `docs/dev/specs/delivery.md`, `docs/dev/specs/user-lifecycle-definition.md`, `docs/dev/specs/operations.md` (cost, privacy, lifecycle), `docs/dev/enduser-coverage-matrix.md` (maintained mapping; `enduser-capabilities-guide.md` archived 2026-08-23), `AGENTS.md`, `README.md`, `CHANGELOG.md` | User types (B1/B2/B3), subscription tiers, check_access, B1 capabilities |
| Validation engine / scenarios | `docs/dev/validation-scenario-contract.md`, `docs/dev/specs/end-user-matrix.yaml` (E8 matrix source, consumed by `scripts/coverage_matrix.py`), `docs/archive/autoinfo-validation-master-plan/` (archived), `docs/dev/validation-reports/` (acceptance + evidence, produced by `scripts/validation_delivery.py` / `scripts/validation_report.py`), `AGENTS.md`, `README.md`, `CHANGELOG.md`, `src/autoinfo/mcp/scenarios/` | Scenario counts (162 = 86 + 76 regression), schema fields, per-run acceptance evidence |
| Alert rules / agent callbacks | `docs/dev/specs/operations.md` §4.6 (source-health polling; `agent-alerting.md` archived 2026-08-23), `AGENTS.md`, `README.md`, `CHANGELOG.md` | Alert rule config, YAML persistence, dispatch |
...
- `README.md`: Features list, Status table, Quick Start, architecture diagram,
  CLI table (31 groups), MCP tools table (149), Demo Domains table, Known Limitations.
...
categories · CLI groups 31 · delivery channels 13 · validation scenarios 162
(86 functional + 75 regression) · demo domains 21.
...
LLM-required tools 16, REST port 8741, test count ~5538.
